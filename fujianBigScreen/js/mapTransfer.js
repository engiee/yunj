// //迁移线
// var transferMap = echarts.init(document.getElementById('transferMap'));
// var myHosName = "福建省";
// var geoCoordMapTransfer = {
//     '安徽': [117.17, 31.52],
//     '北京市': [116.24, 39.55],
//     '重庆市': [106.54, 29.59],
//     '福建省': [119.18, 26.05],
...
//
// var NJData = [
//     [{name:"四川省"},{name: '福建省',value: 68,proportion:"30%"}],
//     [{name:"安徽"},{name: '福建省',value: 58,proportion:"20%"}],
//     [{name:"广东"},{name: '福建省',value: 68,proportion:"29%"}],
//     [{name:"江西"},{name: '福建省',value: 48,proportion:"50%"}],
//     [{name:"新疆维吾尔自治区"},{name: '福建省',value: 78,proportion:"50%"}]
// ];
...
// var convertDataTransfer = function(data) {
//     var res = [];
//     for (var i = 0; i < data.length; i++) {
//         var dataItem = data[i];
//         var fromCoord = geoCoordMapTransfer[dataItem[0].name];
//         var toCoord = geoCoordMapTransfer[dataItem[1].name];
...
// };
//
// var mySeriesTransfer = [];
// [
//     [myHosName, NJData]
// ].forEach(function(item, i) {
//     mySeriesTransfer.push({ //线
//         name: item[0],
//         type: 'lines',
//         zlevel: 1,
//         effect: {
...
//             }
//         },
//         data: convertDataTransfer(item[1])
//     }, { //移动 点
//         name: item[0],
//         type: 'lines',
//         zlevel: 2,
...
//                 value: geoCoordMapTransfer[dataItem[1].name].concat([dataItem[1].value]),
...
//
// $.get('../geo-json-file/china.json',function(chinaJson){
...
//             }
//         },
//         series:mySeriesTransfer
//     };
//     transferMap.setOption(transferOption);
// });
var caseTimer = null;
window.onresize = function () {
    //重置容器高宽
    caseTimer = setTimeout(function () {
        firstTenPartyChart.resize();
